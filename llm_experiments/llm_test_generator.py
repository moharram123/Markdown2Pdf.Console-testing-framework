...
"""
LLM-based test case generator — optional experiment module.
...
<h2>Summary</h2>
<p>Total files: <strong>{summary["total_files"]}</strong><br>
Average coverage: <strong>{int(summary["average_coverage"] * 100)}%</strong><br>
{summary["conclusion"]}</p>
<h2>Detailed Results</h2>
<table>
<tr><th>File</th><th>Category</th><th>Manual Count</th><th>LLM Count</th><th>Matched</th><th>Coverage</th></tr>
{rows}
</table>
</body></html>"""
    ...
    manual_tests = [
        {
            ...
            "expectations": {"headings": ["Introduction", "Features"], "tables": [], "lists": [], "codeblocks": []}
        },
        {
            "file": "control_tables.md",
            "expectations": {"headings": [], "tables": ["Alice", "Bob", "Admin"], "lists": [], "codeblocks": []}
        },
        {
            "file": "control_lists.md",
            "expectations": {"headings": [], "tables": [], "lists": ["First item", "Second item", "Third item"], "codeblocks": []}
        },
        {
            "file": "control_codeblocks.md",
            "expectations": {"headings": [], "tables": [], "lists": [], "codeblocks": ["print("]}
        },
        {
